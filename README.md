...
- [确定性随机数发生器（DRBG）与软件随机数发生器应用指南](./docs/rand.md)
- [后量子密码（PQC）](./docs/pqc.md)
...
**架构优化：**
- **amd64**：NTT、逆NTT 及多项式乘法使用 AVX2 指令集进行向量化优化
- **arm64**：NTT、逆NTT 及多项式乘法使用 NEON 指令集进行向量化优化
- **riscv64**：NTT、逆NTT 及多项式乘法使用向量扩展指令集进行向量化优化
- **loong64**：NTT、逆NTT 及多项式乘法使用 LASX 指令集进行向量化优化
- **ppc64le**：NTT、逆NTT 及多项式乘法使用 VSX / VMX (AltiVec) 指令集进行向量化优化
