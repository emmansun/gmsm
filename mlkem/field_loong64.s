...
TEXT ·internalNTTLASXLayers04(SB), NOSPLIT, $0-8
	MOVV f+0(FP), R4
	MOVV $·zetasMontgomery(SB), R5
...
TEXT ·internalNTTLASXLayers56(SB), NOSPLIT, $0-8
	MOVV f+0(FP), R4
