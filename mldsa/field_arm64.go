...
func init() {
	...
	for i := 0; i < 32; i++ {
		...
		z0MulQNegInvLow32 := zetasMontgomeryMulQNegInvLow32ARM64[64+2*i]
		z1MulQNegInvLow32 := zetasMontgomeryMulQNegInvLow32ARM64[64+2*i+1]
		j := 4 * i
		...
		zetasMontgomeryMulQNegInvLow32L6ReorderedARM64[j+0] = z0MulQNegInvLow32
		zetasMontgomeryMulQNegInvLow32L6ReorderedARM64[j+1] = z0MulQNegInvLow32
		zetasMontgomeryMulQNegInvLow32L6ReorderedARM64[j+2] = z1MulQNegInvLow32
		zetasMontgomeryMulQNegInvLow32L6ReorderedARM64[j+3] = z1MulQNegInvLow32
