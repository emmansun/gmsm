...
lasx_loop:
	...
	XVILVLW X23, X24, X27     // interleave B0,B1 of blocks 0/1 with 2/3 X27 = {B0.w0 B2.w0 B0.w1 B2.w1 | B1.w0 B3.w0 B1.w1 B3.w1}
	XVILVHW X23, X24, X28     // interleave B2,B3 of blocks 0/1 with 2/3 X28 = {B0.w2 B2.w2 B0.w3 B2.w3 | B1.w2 B3.w2 B1.w3 B3.w3}
	XVILVLW X25, X26, X29     // interleave B0,B1 of blocks 4/5 with 6/7 X29 = {B4.w0 B6.w0 B4.w1 B6.w1 | B5.w0 B7.w0 B5.w1 B7.w1}
	XVILVHW X25, X26, X30     // interleave B2,B3 of blocks 4/5 with 6/7 X30 = {B4.w2 B6.w2 B4.w3 B6.w3 | B5.w2 B7.w2 B5.w3 B7.w3}
	XVILVLV X27, X29, X16     // X16 = B0 from all 8 blocks X16 = {B0.w0 B2.w0 B4.w0 B6.w0 | B1.w0 B3.w0 B5.w0 B7.w0}
	XVILVHV X27, X29, X17     // X17 = B1 from all 8 blocks X17 = {B0.w1 B2.w1 B4.w1 B6.w1 | B1.w1 B3.w1 B5.w1 B7.w1}
	XVILVLV X28, X30, X18     // X18 = B2 from all 8 blocks X18 = {B0.w2 B2.w2 B4.w2 B6.w2 | B1.w2 B3.w2 B5.w2 B7.w2}
	XVILVHV X28, X30, X19     // X19 = B3 from all 8 blocks X19 = {B0.w3 B2.w3 B4.w3 B6.w3 | B1.w3 B3.w3 B5.w3 B7.w3}
