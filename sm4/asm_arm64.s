...
#define load_global_data_1() \
  ...
  VMOVQ $0xF052B91BF95BB012, $0xE240AB09EB49A200, M1H;                      \
  VMOVQ $0xEDD14478172BBE82, $0x5B67F2CEA19D0834, M2L;                      \
  VMOVQ $0x11CDBE62CC1063BF, $0xAE7201DD73AFDC00, M2H;                      \
  VMOVQ $0xb27022dc677d9197, $0x56aa3350a3b1bac6, FK_MASK;                  \
  VMOVQ $0x0306090C0F020508, $0x0B0E0104070A0D00, INVERSE_SHIFT_ROWS

#define load_global_data_2() \
  load_global_data_1();                                                     \
  VMOVQ $0x0E0D0C0F0A09080B, $0x0605040702010003, R08_MASK;                 \
  VMOVQ $0x0D0C0F0E09080B0A, $0x0504070601000302, R16_MASK;                 \
  VMOVQ $0x0C0F0E0D080B0A09, $0x0407060500030201, R24_MASK
