...
func TestRingDecodeAndDecompress4RVVMatchesGenericRandom(t *testing.T) {
	requireRVV(t)
	...
	for iter := 0; iter < 1000; iter++ {
		...
		ringDecodeAndDecompress4RVV(&b, &got)
...
func TestRingDecodeAndDecompress4RVVMatchesGenericEdgePatterns(t *testing.T) {
	requireRVV(t)
...
func TestRingDecodeAndDecompress4RVVMatchesGenericExhaustiveSingleByte(t *testing.T) {
	requireRVV(t)
...
func TestRingCompressAndEncode1RVVMatchesGenericRandom(t *testing.T) {
	requireRVV(t)
	...
	for iter := 0; iter < 1000; iter++ {
		...
		ringCompressAndEncode1RVV(got[:], &f)
...
func TestRingCompressAndEncode1RVVMatchesGenericEdgePatterns(t *testing.T) {
	requireRVV(t)
...
func TestRingCompressAndEncode1RVVMatchesGenericExhaustiveSingleValue(t *testing.T) {
	requireRVV(t)
