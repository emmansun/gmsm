...
// GFNI path: uses VGF2P8AFFINEQB/VGF2P8AFFINEINVQB for S-box (2 insns vs ~20)
// Register allocation:
//   Y15 = PRE_MATRIX (constant)
//   Y3  = POST_MATRIX (constant)
//   Y13 = BYTE_FLIP_MASK
//   Y2  = BSWAP_MASK
//   Y4-Y7 = data (8 blocks, words 0-3)
//   Y10-Y12, Y14 = data (second 8 blocks for 16-block path)
//   Y8, Y9, Y0 = temps
//   Y1 = temp (for TRANSPOSE)
...
gfni_tail:
	// For remaining < 128 bytes, reload NIBBLE_MASK and use AVX2 4-block path
	TESTQ DI, DI
	JE gfniEcbSm4Done
	VBROADCASTI128 ·nibble_mask(SB), NIBBLE_MASK
	JMP avx2EcbSm4Nibbles
