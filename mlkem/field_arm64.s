...
DATA ·cbd3Mask249+0(SB)/8, $0x0024924900249249
DATA ·cbd3Mask249+8(SB)/8, $0x0024924900249249
GLOBL ·cbd3Mask249(SB), RODATA, $16

DATA ·cbd3Mask6DB+0(SB)/8, $0x006DB6DB006DB6DB
DATA ·cbd3Mask6DB+8(SB)/8, $0x006DB6DB006DB6DB
GLOBL ·cbd3Mask6DB(SB), RODATA, $16

DATA ·cbd3Mask07+0(SB)/8, $0x0000000700000007
DATA ·cbd3Mask07+8(SB)/8, $0x0000000700000007
GLOBL ·cbd3Mask07(SB), RODATA, $16

DATA ·cbd3Mask70000+0(SB)/8, $0x0007000000070000
DATA ·cbd3Mask70000+8(SB)/8, $0x0007000000070000
GLOBL ·cbd3Mask70000(SB), RODATA, $16
...
TEXT ·samplePolyCBD3NEON(SB), NOSPLIT, $0-16
	...
	VLD1 (R3), [V29.B16]
	MOVD $·cbd3Mask249(SB), R3
	VLD1 (R3), [V28.B16]
	MOVD $·cbd3Mask6DB(SB), R3
	VLD1 (R3), [V27.B16]
	MOVD $·cbd3Mask07(SB), R3
	VLD1 (R3), [V26.B16]
	MOVD $·cbd3Mask70000(SB), R3
	VLD1 (R3), [V25.B16]
