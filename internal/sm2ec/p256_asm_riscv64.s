...
TEXT sm2P256MulInternal<>(SB),NOSPLIT,$0
	...
	SUBS(hlp0, acc2, acc2, t2)
	// SUBCS t0, acc3
	ADD t2, t0, t2        // no carry
	SUBS(t2, acc3, acc3, hlp0)
	// SBC t1, acc0, t2
	SBC(hlp0, t1, acc0, t2)
	...
	ADCS(t0, acc1, acc5, y1, t0, t1)
	ADCS(t0, acc2, acc6, y2, t0, t1)
	ADCS(t0, acc3, acc7, y3, t0, t1)
...
TEXT ·p256FromMont(SB),NOSPLIT,$0
	...
	ADDS(acc2, t3, acc6, hlp0)
	ADD $1, t2, t2
	ADD hlp0, t2, t2         // no carry
	ADDS(acc3, t2, acc7, t0)
...
TEXT ·p256OrdSqr(SB),NOSPLIT,$0
	...
	MOV	p256ordK0<>(SB), hlp1
	MOV	p256ord<>+0x00(SB), const0
	MOV	p256ord<>+0x08(SB), const1
	MOV	p256ord<>+0x10(SB), const2
	MOV	p256ord<>+0x18(SB), const3
	...
	MOV p256orderone<>+0x00(SB), a_ptr
...
ordSqrLoop:
		...
		ADDS(acc1, t0, x1, t1)
		ADDS(t1, acc2, x2, t1)
		MOV p256one<>+0x18(SB), t0
		ADD t1, t0, t0		 // no carry
		ADDS(t0, acc3, x3, t1)
		OR t1, acc4, acc4
		
		SUB $1, acc4, t0        // mask = -cond
		XOR $-1, t0, t1        // t1 = ~mask
