...
TEXT ·blockSM3NI(SB), 0, $0
	...
	MOVD	t+48(FP), R8                               // per-round t constants first address
...
`[1:])
	...
	qroundB(buf, 8, 9, 1, 2, 3, 4, 0)
	qroundB(buf, 8, 9, 2, 3, 4, 0, 1)
	qroundB(buf, 8, 9, 3, 4, 0, 1, 2)
	qroundB(buf, 8, 9, 4, 0, 1, 2, 3)
	qroundB(buf, 8, 9, 0, 1, 2, 3, 4)
	qroundB(buf, 8, 9, 1, 2, 3, 4, 0)
	qroundB(buf, 8, 9, 2, 3, 4, 0, 1)
	qroundB(buf, 8, 9, 3, 4, 0xff, 0xff, 0xff)
	qroundB(buf, 8, 9, 4, 0, 0xff, 0xff, 0xff)
	qroundB(buf, 8, 9, 0, 1, 0xff, 0xff, 0xff)
